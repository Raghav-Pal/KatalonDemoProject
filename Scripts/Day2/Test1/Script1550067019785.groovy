...
WebUI.navigateToUrl('https://opensource-demo.orangehrmlive.com/login')
...
WebUI.setText(findTestObject('Page_OrangeHRM/input_Username_searchSystemUse'), 'Admin')
...
WebUI.click(findTestObject('Page_OrangeHRM/b_Maintenance'))
